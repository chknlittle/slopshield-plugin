...
The extension sends those video URLs, channel IDs, and requested caption text to `https://slopshield-api.chkn.computer` solely to classify AI-generated videos and return the filtering result. It does not send the user's YouTube account credentials, cookies, watch history, or the contents of unrelated pages.
